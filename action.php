			...
			while ($row=mysqli_fetch_array($query)) {
				...
				echo '
					<div class="row">
						...
						<div class="col-md-3"><img class="img-responsive h-150 w-150" src="product_images/'.$product_image.'" /></div>
				...
				while ($row=mysqli_fetch_array($query)) {
					...
					echo 
						'<div class="row">
								...
								<div class="col-md-2"><img class="img-fluid" src="product_images/'.$product_image.'"></div>
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="checkout.php" method="GET">';
							...
							echo   
									'<button class="btn btn-success float-end mt-4" type="submit"><i class="fa fa-cart-shopping"></i>Checkout</button>
